...
typedef ChecklistView IndexedChecklistBuilder(
    BuildContext context, int checklistIndex);
typedef ChecklistItemView IndexedChecklistItemBuilder(
    BuildContext context, int checklistIndex, int itemIndex);
...
class ChecklistListViewState extends State<ChecklistListView>
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.checklists != null) {
      for (int i = 0; i < widget.checklists.length; i++) {
        ...
        checklistWidgets.add(Opacity(
            opacity:
                (draggedListIndex == i && draggedItemIndex == null) ? 0 : 1,
    ...
    if (initialX != null &&
      ...
      if (canDrag && dxInit != null && dyInit != null) {
        if (draggedItemIndex != null && draggedItem != null) {
          ...
          if (checklistStates[draggedListIndex].footerHeight != null) {
            ...
            topPadding += checklistStates[draggedListIndex].headerHeight -
                checklistStates[draggedListIndex].footerHeight / 2;
          }
          ...
          if (0 <= draggedItemIndex - 1 &&
            ...
            moveUp();
              ...
              checklistStates[draggedListIndex].headerHeight != null &&
      ...
      if (draggedListIndex != null) {
        localPosition =
            (dy - offsetY) + initialY; //From Checklist Local position
        bottomList = 0;
        topList = 0;
        for (var i = 0; i < checklistStates.length; i++) {
          if (i <= draggedListIndex) {
            RenderBox box = checklistStates[i].context.findRenderObject();
              ...
              if (draggedItem != null) {
                ...
                if (widget.controller != null) {
                  ...
                  widget.controller.jumpTo(
                      (pos > widget.controller.position.maxScrollExtent)
